...
public class update : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        dal.project_update(title, text, guid,type,colar,date_start,date_end,host_name,(name_group.Length+host_a_cont).ToString(),allname,all_emp,host_emp,saa_name,saa_empno);
