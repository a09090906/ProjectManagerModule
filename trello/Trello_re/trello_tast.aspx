        ...
        <form>
            ...
            <div class="WrapperFooter">
                <div class="footerblock container font-white">
                     建議瀏覽解析度1024x768以上<br />
                   網站製作：劉冠麟｜意見反應｜系統使用說明書
                </div>
                <!--{* footerblock *}-->
            </div>
            <!-- WrapperFooter -->
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a onclick="Find_Empno1()">
                                        <img id="img_name" src="../images/icon_search.png" border="0" class="ajax_mesg btn_mouseout" />
                                    </a><br />
                                     <div id="sa_select" name="sa_emp_sle" class="emp_list"  style="display:none;">
                                        <iframe id="sa_sle" src="singleselect.aspx" width="630" height="200"></iframe>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a onclick="Find_Empno3()">
                                        <img id="img_saa" src="../images/icon_search.png" border="0" class="ajax_mesg btn_mouseout" />
                                    </a><br />
                                    <div id="si_sle" name="ast_emp_sle" class="emp_list"  style="display:none;">
                                        <iframe id="sig_sle" name="ast_emp_if" src="singleselect.aspx" width="630" height="200"></iframe>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a onclick="Find_Empno()">
                                        <img id="img_promoter_name" src="../images/icon_search.png" border="0" class="ajax_mesg btn_mouseout" />
                                    </a><br />
                                    <div id="sle" name="mut_emp_sle"  class="emp_list" style="display:none;">
                                        <iframe name="mut_emp_if" src="multileselect.aspx" width="630" height="200" ></iframe>
                                     </div>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="colse" onclick="Find_Empno1()">
                                        <img id="img_name1" src="../images/icon_search.png" border="0" class="ajax_mesg btn_mouseout" />
                                    </a><br />
                                     <div  name="sa_emp_sle" class="emp_list"  style="display:none;">
                                        <iframe name="sa_emp_if" src="singleselect.aspx" width="630" height="200"></iframe>
                                    </div>
                                </td>
                            </tr>
                             <tr>
                                ...
                                <td>
                                    ...
                                    <a onclick="Find_Empno3()">
                                        <img id="img_sa" src="../images/icon_search.png" border="0" class="ajax_mesg btn_mouseout" /><%--<i class="fa fa-binoculars" aria-hidden="true"/>--%>
                                    </a><br />
                                    <div  name="ast_emp_sle" class="emp_list"  style="display:none;">
                                        <iframe  name="ast_emp_if" src="singleselect.aspx" width="630" height="200"></iframe>
                                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="colse" onclick="Find_Empno()">
                                        <%--<i class="fa fa-binoculars" aria-hidden="true" />--%>
                                        <img id="img_promoter_name1" src="../images/icon_search.png" border="0" class="ajax_mesg btn_mouseout" />
                                    </a><br />
                                    <div  name="mut_emp_sle"  class="emp_list" style="display:none;">
                                        <iframe name="mut_emp_if" src="multileselect.aspx" width="630" height="200" ></iframe>
                                     </div>
                                </td>
                            </tr>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', "#addboardbtn", function () {
                ...
                $("#mut_sle").attr('src', $("#mut_sle").attr('src'));//重新整理
                $("#sig_sle").attr('src', $("#sig_sle").attr('src'));//重新整理
        ...
        function databuid() {
            $.ajax({
                ...
                success: function (data) {
                    $("#monsortable").empty();
                    var news = '<li><a id="addboardbtn" name="addboardbtn" href= "#editcardblock" class="addbtnbox width100  open-popup-link" > <i class="fa fa-plus-circle font-size18" aria-hidden="true"></i> <br/>新增專案</a ></li >';
                    if (data != null) {
                        data = $.parseXML(data);
                        var tabstr = '';
        ...
        //成員挑選        
        function select_fun(empno,name) {
            $('#name_tex').val(name);
            $('#edit_text_name').val(name);
            $('#empno_tex').val(empno);
            $('#edit_empno_name').val(empno);
        };
        var find = 'n';
        function Find_Empno() {
            if (find == 'n') {
                $(".emp_list").css("display", "none");
                $('div[name="mut_emp_sle"]').css("display", "");
                find = 'y';
            }
            else {
                $(".emp_list").css("display", "none");
                $('div[name="mut_emp_sle"]').css("display", "none");
                find = 'n';
            }
        ...
        var find1_n = 'n';
        //主持人挑選
        function Find_Empno1() {      
            if (find1_n == 'n') {
                $(".emp_list").css("display", "none");
                $('div[name="sa_emp_sle"]').css("display", "");
                $('iframe[name="sa_emp_if"]').contents().find("#sa_chenge").val("SA");
                find1_n = 'y'
            }
            else {
                $(".emp_list").css("display", "none");
                $('div[name="sa_emp_sle"]').css("display", "none");
                $('iframe[name="sa_emp_if"]').contents().find("#sa_chenge").val("SA");
                find1_n = 'n';
            }              
        }
        function sa_select_fun(empno, name) {
            $('#emp_tex').val(empno);
            $('#edit_empno_sa').val(empno);
            $('#sa_tex').val(name);
            $('#edit_text_sa').val(name);
        };


        var find_3 ='n'
        //助理主持人挑選
        function Find_Empno3() {
            if (find_3 == 'n') {
                $(".emp_list").css("display", "none");
                $('div[name="ast_emp_sle"]').css("display", "");
                $('iframe[name="ast_emp_if"]').contents().find("#sa_chenge").val("A");
                find_3 = 'y'
            }
            else {
                $(".emp_list").css("display", "none");
                $('div[name="ast_emp_sle"]').css("display", "none");
                $('iframe[name="ast_emp_if"]').contents().find("#sa_chenge").val("A");
                find_3 = 'n';
            }
        }
        function single_select_fun(empno, name) {
            $('#empa_tex').val(empno);
            $('#edit_empno_a').val(empno);
            $('#saa_tex').val(name);
            $('#edit_name_a').val(name);
